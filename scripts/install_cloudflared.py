"""
install_cloudflared.py

Install cloudflared if it is missing.

Usage:
    python install_cloudflared.py
    python install_cloudflared.py --verbose
    python install_cloudflared.py --reinstall
    python install_cloudflared.py --no-package-manager

Library usage:
    from install_cloudflared import ensure_cloudflared
...
# from install_cloudflared import ensure_cloudflared
# cloudflared = ensure_cloudflared().path
# # Example:
# # subprocess.run([str(cloudflared), "tunnel", "--url", "http://localhost:8000"])
